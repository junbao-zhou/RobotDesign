...
// ==============================================================
#ifndef __test_mac_muladd_2qcK__HH__
#define __test_mac_muladd_2qcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mac_muladd_2qcK) {
    ...
    SC_CTOR(test_mac_muladd_2qcK):  simcore_mac_0_U ("simcore_mac_0_U") {
