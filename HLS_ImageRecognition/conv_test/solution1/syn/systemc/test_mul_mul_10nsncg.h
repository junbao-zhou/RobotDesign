...
// ==============================================================
#ifndef __test_mul_mul_10nsncg__HH__
#define __test_mul_mul_10nsncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_10nsncg) {
    ...
    SC_CTOR(test_mul_mul_10nsncg):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
