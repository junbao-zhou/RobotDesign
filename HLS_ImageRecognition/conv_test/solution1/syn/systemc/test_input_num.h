...
// ==============================================================
#ifndef __test_input_num_H__
#define __test_input_num_H__
...
test_input_num_ram* meminst;


SC_CTOR(test_input_num) {
meminst = new test_input_num_ram("test_input_num_ram");
