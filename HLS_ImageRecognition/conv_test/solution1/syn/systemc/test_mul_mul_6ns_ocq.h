...
// ==============================================================
#ifndef __test_mul_mul_6ns_ocq__HH__
#define __test_mul_mul_6ns_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(test_mul_mul_6ns_ocq) {
    ...
    SC_CTOR(test_mul_mul_6ns_ocq):  ACMP_smul_us_U ("ACMP_smul_us_U") {
