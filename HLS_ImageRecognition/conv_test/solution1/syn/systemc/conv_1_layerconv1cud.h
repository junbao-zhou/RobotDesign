...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(conv_1_layerconv1cud_ram) {
        ram[0] = "0b0011001110101100";
        ram[1] = "0b1010100000001000";
        ram[2] = "0b1011010101100000";
        ram[3] = "0b0011001011101001";
        ram[4] = "0b0010111011101000";
        ram[5] = "0b0011010111101011";
        ram[6] = "0b0010101010011011";
        ram[7] = "0b0011011010000101";
